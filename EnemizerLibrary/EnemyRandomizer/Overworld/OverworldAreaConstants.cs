...
namespace EnemizerLibrary
{
    public class OverworldAreaConstants
    {
        ...
        static Dictionary<int, string> areaNames = new Dictionary<int, string>()
        {
            ...
            { 0x082, "Unknown Area 0x82??" },
            { 0x083, "Unknown Area 0x83??" },
            { 0x084, "Unknown Area 0x84??" },
            { 0x085, "Unknown Area 0x85??" },
            { 0x086, "Unknown Area 0x86??" },
            { 0x087, "Unknown Area 0x87??" },
            { 0x088, "Unknown Area 0x88??" },
            { 0x089, "Unknown Area 0x89??" },
            { 0x08A, "Unknown Area 0x8A??" },
            { 0x08B, "Unknown Area 0x8B??" },
            { 0x08C, "Unknown Area 0x8C??" },
            { 0x08D, "Unknown Area 0x8D??" },
            { 0x08E, "Unknown Area 0x8E??" },
            { 0x08F, "Unknown Area 0x8F??" },
